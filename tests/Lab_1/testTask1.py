...
aList = reader.readDataFromFile("data/testTask1Data1.json")
aList.prettyPrint()
...
aMatrix2 = reader.readDataFromFile("testTask2Data2.json")
...
aIndiceMatrix3 = reader.readDataFromFile("testTask3Data3.json")
